...
import { businessSetupConfigApi } from '../../services/admin-api'
...
export default function BusinessSetupConfigPage() {
  return <GenericCrudPage title="Business Setup Config" api={businessSetupConfigApi} columns={columns} fields={fields} />
}
