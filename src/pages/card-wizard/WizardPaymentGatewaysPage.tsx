...
import { wizardPaymentGatewaysApi } from '../../services/admin-api'
...
export default function WizardPaymentGatewaysPage() {
  return <GenericCrudPage title="Wizard Payment Gateways" api={wizardPaymentGatewaysApi} columns={columns} fields={fields} />
}
