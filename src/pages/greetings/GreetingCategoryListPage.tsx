...
import { mockGreetingCategories } from '../../services/mock-data'
...
export default function GreetingCategoryListPage() {
  ...
  const [data, setData] = useState<GreetingCategory[]>([...mockGreetingCategories])
  ...
  const handleSubmit = () => {
    ...
    if (editingItem) {
      ...
      const newItem: GreetingCategory = { id: Date.now(), name: form.name, slug: form.slug, icon_url: form.icon_url, sort_order: form.sort_order, is_active: form.is_active, template_count: 0 }
