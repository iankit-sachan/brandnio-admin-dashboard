...
import { logoIndustriesApi } from '../../services/admin-api'
...
export default function LogoIndustriesPage() {
  return <GenericCrudPage title="Logo Industries" api={logoIndustriesApi} columns={columns} fields={fields} />
}
