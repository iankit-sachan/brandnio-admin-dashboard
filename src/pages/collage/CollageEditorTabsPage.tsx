...
import { collageEditorTabsApi } from '../../services/admin-api'
...
const columns: Column<any>[] = [
  ...
  { key: 'tab_type', title: 'Tab Type', sortable: true, render: (item) => <span>{item.tab_type || '--'}</span> },
...
const fields: FieldDef[] = [
  ...
  { key: 'tab_type', label: 'Tab Type', type: 'text' },
  { key: 'display_order', label: 'Display Order', type: 'number' },
  { key: 'is_active', label: 'Active', type: 'checkbox' },
]

export default function CollageEditorTabsPage() {
  return <GenericCrudPage title="Collage Editor Tabs" api={collageEditorTabsApi} columns={columns} fields={fields} />
}
